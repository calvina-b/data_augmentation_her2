    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          func.saveImgs(X_test, y_test, unet, j, 7)
          unet.save('/home/calvina/saved_models/HDAB/HER2_image_HDAB_segmentation_initial_and_noise_dataset.hdf5')
...
print(res)
df.to_csv('/home/calvina/data/HDAB/07optimization_HDAB_initial_and_noise_dataset.csv', index=False)