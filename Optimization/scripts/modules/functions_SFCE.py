...
def saveImgs(X_test, y_test, unet, thresh, id):
    experiments = ['exp11-SFCE-full-dataset', 'exp11-HDAB-SFCE-full-dataset', 'exp12-SFCE-ER-full-dataset', 'exp12-HDAB-SFCE-ER-full-dataset']

    path = '/home/calvina/imgs/SFCE'
    if not os.path.exists(path) and not os.path.isdir(path):
        os.mkdir(path)

    path2 = '/home/calvina/imgs/SFCE/%s' % experiments[id - 1]
