...
def saveImgs(X_test, y_test, unet, thresh, id):
    experiments = ['exp1-HDAB-initial-dataset', 'exp2-HDAB-initial-and-blur-dataset', 'exp3-HDAB-initial-and-brightness-dataset', 
    'exp4-HDAB-initial-and-contrast-dataset', 'exp5-HDAB-initial-and-crop-dataset', 'exp6-HDAB-initial-and-flipped-dataset',
    'exp7-HDAB-initial-and-noise-dataset', 'exp8-HDAB-initial-and-rotation-dataset', 'exp9-HDAB-initial-and-transpose-dataset',
    'exp10-HDAB-full-dataset']

    path = '/home/calvina/imgs/HDAB'
    if not os.path.exists(path) and not os.path.isdir(path):
        os.mkdir(path)

    path2 = '/home/calvina/imgs/HDAB/%s' % experiments[id - 1]
