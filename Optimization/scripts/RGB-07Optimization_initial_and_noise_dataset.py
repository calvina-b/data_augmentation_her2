    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('saved_models/RGB/HER2_image_segmentation_initial_and_noise_dataset.hdf5')
...
print(res)
df.to_csv('data/RGB/07optimization_initial_and_noise_dataset.csv', index=False)