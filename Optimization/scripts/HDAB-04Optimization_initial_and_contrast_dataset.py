    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          func.saveImgs(X_test, y_test, unet, j, 4)
          unet.save('/home/calvina/saved_models/HDAB/HER2_image_HDAB_segmentation_initial_and_contrast_dataset.hdf5')
...
print(res)
df.to_csv('/home/calvina/data/HDAB/04optimization_HDAB_initial_and_contrast_dataset.csv', index=False)