...
def saveImgs(X_test, y_test, unet, thresh):
    ...
    path2 = '/home/calvina/imgs/exp3-initial-and-brightness-dataset'
    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('saved_models/HER2_image_segmentation_initial_and_brightness_dataset.hdf5')
...
print(res)
df.to_csv('03optimization_initial_and_brightness_dataset.csv', index=False)