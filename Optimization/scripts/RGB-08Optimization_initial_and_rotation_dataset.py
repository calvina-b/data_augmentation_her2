    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          func.saveImgs(X_test, y_test, unet, j, 8)
          unet.save('saved_models/RGB/HER2_image_segmentation_initial_and_rotation_dataset.hdf5')
...
print(res)
df.to_csv('data/RGB/08optimization_initial_and_rotation_dataset.csv', index=False)