...
def saveImgs(X_test, y_test, unet, thresh):
    ...
    path2 = '/home/calvina/imgs/exp6-initial-and-flipped-dataset'
    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('saved_models/HER2_image_segmentation_initial_and_flipped_dataset.hdf5')
...
print(res)
df.to_csv('06optimization_initial_and_flipped_dataset.csv', index=False)