...
def saveImgs(X_test, y_test, unet, thresh):
    ...
    path2 = '/home/calvina/imgs/exp9-initial-and-transpose-dataset'
    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('saved_models/HER2_image_segmentation_initial_and_transpose_dataset.hdf5')
...
print(res)
df.to_csv('09optimization_initial_and_transpose_dataset.csv', index=False)