...
def saveImgs(X_test, y_test, unet, thresh):
    ...
    path2 = '/home/calvina/imgs/exp1-initial-dataset'
    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('saved_models/HER2_image_segmentation_initial_dataset.hdf5')
...
print(res)
df.to_csv('01optimization_initial_dataset.csv', index=False)