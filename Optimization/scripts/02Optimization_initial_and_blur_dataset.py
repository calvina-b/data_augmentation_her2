...
def saveImgs(X_test, y_test, unet, thresh):
    ...
    path2 = '/home/calvina/imgs/exp2-initial-and-blur-dataset'
    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('saved_models/HER2_image_segmentation_initial_and_blur_dataset.hdf5')
...
print(res)
df.to_csv('02optimization_initial_and_blur_dataset.csv', index=False)