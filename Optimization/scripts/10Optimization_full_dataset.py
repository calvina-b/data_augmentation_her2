...
def saveImgs(X_test, y_test, unet, thresh):
    ...
    path2 = '/home/calvina/imgs/exp10-full-dataset'
    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('saved_models/HER2_image_segmentation_full_dataset.hdf5')
...
print(res)
df.to_csv('10optimization_full_dataset.csv', index=False)