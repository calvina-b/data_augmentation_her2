    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('/home/calvina/saved_models/HDAB/HER2_image_HDAB_segmentation_initial_dataset.hdf5')
...
print(res)
df.to_csv('/home/calvina/data/HDAB/01optimization_HDAB_initial_dataset.csv', index=False)