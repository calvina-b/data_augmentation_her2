    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          func.saveImgs(X_test, y_test, unet, j, 10)
          unet.save('saved_models/RGB/HER2_image_segmentation_full_dataset.hdf5')
...
print(res)
df.to_csv('data/RGB/10optimization_full_dataset.csv', index=False)