    ...
    for k in learning_rate:
      for e in epochs:
        ...
        if f1_score > prev_f1_value:
          ...
          unet.save('/home/calvina/saved_models/HDAB/HER2_image_segmentation_HDAB_full_dataset.hdf5')
...
print(res)
df.to_csv('/home/calvina/data/HDAB/10optimization_HDAB_full_dataset.csv', index=False)